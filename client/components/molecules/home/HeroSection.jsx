...
const HeroSection = () => {
  ...
  return (
    <div className="h-screen mb-32">
      <div className="overlay flex flex-col items-center gap-y-5 justify-center">
        ...
        <div className="flex justify-around mt-7 md:flex-row flex-col">
          <button className="button-glitch mx-5 md:my-1 my-3">Register</button>
