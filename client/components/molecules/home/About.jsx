...
const About = () => {
  ...
  return (
    ...
    >
      <div
        className="w-screen sm:pl-12 pr-8 ms-16 flex flex-col sm:flex-row items-center justify-around"
        style={{ height: "50vh" }}
      >
        <motion.div>
          ...
          <div className="mr-4 sm:mr-0 sm:px-2 w-screen text-base xl:text-2xl lg:text-2xl xl:w-[500px] xl:p-6 md:text-2xl md:w-[350px] sm:text-xl sm:w-[250px] sm:ml-8 sm:p-0">
